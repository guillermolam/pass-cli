...
//! Generated file from `folder_v1.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_2;

// @@protoc_insertion_point(message:proton_pass_folder_v1.Folder)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Folder {
    // message fields
    // @@protoc_insertion_point(field:proton_pass_folder_v1.Folder.name)
    pub name: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:proton_pass_folder_v1.Folder.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0ffolder_v1.proto\x12\x15proton_pass_folder_v1\"\x1c\n\x06Folder\x12\
