        ...
        let req = self
            .create_item_request(
                ...
                ItemContent::Identity(Box::new(IdentityItem {
                    ...
                    floor: trim_value(&payload.floor.unwrap_or_default()),
                    county: trim_value(&payload.county.unwrap_or_default()),
                    ...
                    x_handle: trim_value(&payload.x_handle.unwrap_or_default()),
                    second_phone_number: trim_value(
                        &payload.second_phone_number.unwrap_or_default(),
                    ),
                    linkedin: trim_value(&payload.linkedin.unwrap_or_default()),
                    reddit: trim_value(&payload.reddit.unwrap_or_default()),
                    facebook: trim_value(&payload.facebook.unwrap_or_default()),
                    yahoo: trim_value(&payload.yahoo.unwrap_or_default()),
                    instagram: trim_value(&payload.instagram.unwrap_or_default()),
                    ...
                    personal_website: trim_value(&payload.personal_website.unwrap_or_default()),
                    work_phone_number: trim_value(&payload.work_phone_number.unwrap_or_default()),
                    work_email: trim_value(&payload.work_email.unwrap_or_default()),
